<div class="wrap">
    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            <?php if (current_user_can('edit_email')) : ?>                        <a href="<?php menu_page_url('mail-client'); ?>&action=edit&id=<?= $mail->id; ?>" class="button bg-warning text-white">editer</a>
            <?php endif; ?>
            <?php if (current_user_can('delete_email')) : ?>            <form class="form-inline d-inline-block" action="<?php get_site_url(); ?>?action=mail-delete" method="post">
